...
import { useAuth } from '../contexts/AuthContext'; // Assuming AuthContext provides logout

/**
 * Sidebar component
 * Provides navigation links for the application and a logout button.
 */
const Sidebar = () => {
      ...
      <div className="flex flex-col justify-between flex-1">
        ...
        <div className="mt-auto">
          <button
            ...
            className="flex items-center w-full px-3 py-2.5 text-sm font-medium text-neutral-text-secondary transition-colors duration-200 transform rounded-lg hover:bg-red-500 hover:text-white"
          >
